# صيدلية السليماني - نظام الإدارة

نظام إدارة متكامل لصيدلية السليماني لنظام Windows.

## نبذة عن المشروع

**صيدلية السليماني** هو نظام إدارة صيدلية متكامل يعمل على نظام Windows، مبني باستخدام Flutter. يهدف النظام إلى استبدال الإدارة اليدوية بنظام رقمي يضمن:
- دقة المخزون
- تتبع الصلاحيات
