...
extension CustomerModelQuerySortBy
  ...
  QueryBuilder<CustomerModel, CustomerModel, QAfterSortBy> sortByDebtBalance() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerModelQuerySortThenBy
  ...
  QueryBuilder<CustomerModel, CustomerModel, QAfterSortBy> thenByDebtBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'debtBalance', Sort.asc);
    });
  }
...
extension CustomerModelQueryProperty
  ...
  QueryBuilder<CustomerModel, double, QQueryOperations> debtBalanceProperty() {
    return QueryBuilder.apply(this, (query) {
