...
const SaleItemModelSchema = CollectionSchema(
  ...
  links: {
    r'sale': LinkSchema(
      id: -6029605753574184639,
      name: r'sale',
      target: r'SaleModel',
      single: true,
    ),
    r'product': LinkSchema(
      id: 7976853568271209145,
      name: r'product',
...
void _saleItemModelSerialize(
  ...
  writer.writeDouble(offsets[1], object.total);
...
SaleItemModel _saleItemModelDeserialize(
  ...
  object.id = id;
  object.quantity = reader.readLong(offsets[0]);
  object.total = reader.readDouble(offsets[1]);
...
extension SaleItemModelQueryLinks
    on QueryBuilder<SaleItemModel, SaleItemModel, QFilterCondition> {
  QueryBuilder<SaleItemModel, SaleItemModel, QAfterFilterCondition> sale(
  ...
  QueryBuilder<SaleItemModel, SaleItemModel, QAfterFilterCondition> product(
...
extension SaleItemModelQuerySortBy
  ...
  QueryBuilder<SaleItemModel, SaleItemModel, QAfterSortBy> sortByQuantity() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SaleItemModel, SaleItemModel, QAfterSortBy> sortByTotal() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'total', Sort.asc);
    });
  }

  QueryBuilder<SaleItemModel, SaleItemModel, QAfterSortBy> sortByTotalDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'total', Sort.desc);
    });
  }

  QueryBuilder<SaleItemModel, SaleItemModel, QAfterSortBy> sortByUnitPrice() {
    return QueryBuilder.apply(this, (query) {
...
extension SaleItemModelQuerySortThenBy
  ...
  QueryBuilder<SaleItemModel, SaleItemModel, QAfterSortBy> thenByQuantity() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'quantity', Sort.asc);
    });
  }
  ...
  QueryBuilder<SaleItemModel, SaleItemModel, QAfterSortBy> thenByTotal() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'total', Sort.asc);
    });
  }

  QueryBuilder<SaleItemModel, SaleItemModel, QAfterSortBy> thenByTotalDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'total', Sort.desc);
    });
  }

  QueryBuilder<SaleItemModel, SaleItemModel, QAfterSortBy> thenByUnitPrice() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'unitPrice', Sort.asc);
    });
  }
...
extension SaleItemModelQueryWhereDistinct
  ...
  QueryBuilder<SaleItemModel, SaleItemModel, QDistinct> distinctByQuantity() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'quantity');
    });
  }

  QueryBuilder<SaleItemModel, SaleItemModel, QDistinct> distinctByTotal() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'total');
    });
  }

  QueryBuilder<SaleItemModel, SaleItemModel, QDistinct> distinctByUnitPrice() {
    return QueryBuilder.apply(this, (query) {
...
extension SaleItemModelQueryProperty
  ...
  QueryBuilder<SaleItemModel, int, QQueryOperations> quantityProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'quantity');
    });
  }

  QueryBuilder<SaleItemModel, double, QQueryOperations> totalProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'total');
    });
  }

  QueryBuilder<SaleItemModel, double, QQueryOperations> unitPriceProperty() {
    return QueryBuilder.apply(this, (query) {
